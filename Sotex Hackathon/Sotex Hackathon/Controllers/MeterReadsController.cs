...
namespace Sotex_Hackathon.API
{
    ...
    {
        private readonly IGenericService<MeterReads> _service;

        public MeterReadsController(IGenericService<MeterReads> service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] MeterReads entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] MeterReads entity)
        {
