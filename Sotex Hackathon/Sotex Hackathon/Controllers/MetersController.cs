...
namespace Sotex_Hackathon.API
{
    ...
    {
        private readonly IGenericService<Meters> _service;

        public MetersController(IGenericService<Meters> service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Meters entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Meters entity)
        {
